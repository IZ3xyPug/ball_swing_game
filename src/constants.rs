...
pub const MOMENTUM_CAP:   f32 = 52.0;
...
pub const SPINNER_HIT_PUSH_X:f32 = 5.5;
pub const SPINNER_HIT_PUSH_Y:f32 = -14.0;
pub const BOOST_POOL_SIZE:   usize = 48;
pub const BOOST_GAP_MIN:     f32 = 850.0;
pub const BOOST_GAP_MAX:     f32 = 1700.0;
...
pub const FLIP_GAP_MIN:      f32 = 4200.0;
pub const FLIP_GAP_MAX:      f32 = 6800.0;
